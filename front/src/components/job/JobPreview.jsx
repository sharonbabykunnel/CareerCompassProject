...
import { ArrowBigLeft, BriefcaseBusiness, Hourglass, MapPin } from 'lucide-react';
...
const JobPreview = () => {
    ...
    const navigateToApplications = (id)=>{
        navigate('/job/applications',{state:{id}})
      }
    const closeModal = ()=>{
        setIsOpen(false)
    }
    ...
    return (
        <>
         ...
         <ThreeDots
          ...
          !job ? (
            <div className="flex flex-col justify-center items-center relative p-6 mb-6 border border-gray-300 rounded-lg bg-white shadow-md w-full   h-full mx-auto">
              <Hourglass className="w-12 h-12 mb-4 text-gray-500" />
           ...
           <div className="bg-white rounded-lg shadow-xl h-full w-full flex flex-col  overflow-y-auto">
            <div className="p-6 flex flex-col flex-grow ">
              ...
              <div className="flex justify-between items-center mb-4">
                ...
                <Link to='/job/posted-jobs'  className="text-gray-400 hover:text-gray-600">
              ...
              <div >
                    ...
                    <div className="flex flex-col  text-sm text-gray-600 mb-4 mt-4">
                      ...
                      <p>Total applicants: {job?.appication?.length || 0}</p>
                    </div>
                    </div>
                  ...
                  <JobModal setJob={setJob} closeModal={closeModal} isOpen={isOpen} job={job} />
            </>
          )}
        </>
      );
